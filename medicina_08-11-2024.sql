...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2024 a las 21:30:31
...
(7, 3, 4, 1, 'reservar', 0, '2024-10-22', '2024-10-20');
...
CREATE TABLE `codigo_categoria_medicamento` (
  ...
  `categoria` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
INSERT INTO `codigo_categoria_medicamento` (`codigo`, `categoria`) VALUES
('CODIGO', 'CATEGORÍA '),
('1', 'Anestésicos'),
('', ''),
('', ''),
...
('', ''),
('', ''),
('11', 'Medicinas_con_afectación_sanguínea'),
('', ''),
('', ''),
('', ''),
('', ''),
...
('', ''),
('', ''),
('13', 'Preparaciones_Dermatológicas'),
('', ''),
('', ''),
('', ''),
('', ''),
...
('', ''),
('', ''),
('17', 'Fármacos_Gastrointestinales'),
('', ''),
('', ''),
('', ''),
('', ''),
...
('', ''),
('', ''),
('20', 'Antidiarreico_sales_de_rehidratación_oral'),
('', ''),
('', ''),
('', ''),
('', ''),
('', ''),
('', ''),
('21', 'Preparaciones_Oftalmológicas'),
('', ''),
('', ''),
('', ''),
('', ''),
...
('', ''),
('', ''),
('23', 'Antiasmáticos_Antitusígenos'),
('', ''),
('', ''),
('', ''),
('', ''),
...
INSERT INTO `consultas` (`id_consulta`, `id_especialidad`, `id_tipo_consulta`, `id_persona`, `diagnostico`, `peso`, `altura`, `presion_arterial`, `edad`, `id_recipe`, `id`, `fecha_registro`, `fecha_actualizacion`) VALUES
(19, 2, 8, 1, 'Tos seca', 40, 2, '120/80', NULL, 25, 28, '2024-10-17', NULL),
(20, 2, 8, 2, 'tos seca', 60, 2, '120/80', NULL, 26, 28, '2024-10-17', NULL),
(41, 4, 8, 1, 'Cuadro de depresión', 0, 0, '', NULL, 66, 28, '2024-10-19', NULL),
(42, 4, 8, 1, 'Cuadro de depresión', 0, 0, '', NULL, 67, 28, '2024-10-19', NULL),
(43, 4, 8, 1, 'Cuadro de depresión', 0, 0, '', NULL, 68, 28, '2024-10-19', NULL),
(44, 4, 8, 1, 'Cuadro de depresión', 0, 0, '', NULL, 69, 28, '2024-10-19', NULL),
(45, 4, 8, 1, 'Cuadro de depresión', 0, 0, '', NULL, 70, 28, '2024-10-19', NULL),
(46, 2, 8, 1, 'tos seca', 60, 1, '120/80', NULL, 71, 28, '2024-10-22', NULL);
...
(1, 4, 4, 'Lunes', 'Viernes', '00:00:00', '00:00:00');
...
CREATE TABLE `especialidad` (
  ...
  `tm_porcita` varchar(11) NOT NULL DEFAULT 'N/A'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'MEDICINA GENERAL', 'Sin cita', 'N/A'),
(3, 'PEDIATRIA', 'Sin cita', 'N/A'),
(4, 'PSICOLOGIA', 'Por cita', '30 Min'),
(5, 'CARDIOLOGÍA', 'Sin cita', 'N/A');
...
INSERT INTO `personas` (`id_persona`, `n_documento`, `tipo_documento`, `nombres`, `apellidos`, `fecha_nacimiento`, `sexo`, `telefono`, `direccion`, `correo`, `fecha_registro`, `id_estado`, `id_municipio`, `id_parroquia`) VALUES
(1, '29596688', 'V', 'Kleiber Antonio', 'Aranguren Pacheco', '2003-11-08', 'Masculino', '04161454551', 'Ruiz pineda, primera subida a los telares casa numero 1.', 'kleiber8113@gmail.com', '2024-10-05', NULL, NULL, NULL),
(2, '22589653', 'V', 'Jesus', 'Gonzalez', '1994-05-11', 'Masculino', '04165960483', 'La candelaria', 'jesus12@gmail.com', '2024-10-06', NULL, NULL, NULL),
(3, '22186952', 'V', 'Juan  Andres', 'Bouza', '1991-09-20', 'Masculino', '04165960485', 'Montalban', 'juanabouza@gmail.com', '2024-10-06', NULL, NULL, NULL),
(4, '21564398', 'V', 'jonatan', 'Masias', '1994-12-08', 'Masculino', '04161454552', 'Coche', 'correo@gmail.com', '2024-10-19', NULL, NULL, NULL);
...
(5, 28, '...', '2024-08-31'),
(6, 28, '...', '2024-09-12'),
(7, 28, 'Solo tome las pastillas', '2024-09-12'),
(8, 28, '...', '2024-09-12'),
(9, 28, 'Administrar antes de cada comida.', '2024-09-16'),
(10, 28, 'Adicional', '2024-09-25'),
(11, 28, '...', '2024-09-30'),
(12, 28, 'tomar abundante agua.', '2024-10-02'),
(13, 28, '...', '2024-10-03'),
(14, 28, '', '2024-10-04'),
(15, 28, '...', '2024-10-06'),
(16, 28, '...', '2024-10-12'),
...
(22, 28, '...', '2024-10-12'),
(23, 28, '...', '2024-10-12'),
(24, 28, 'Tomar antes de la comida.', '2024-10-13'),
(25, 28, 'tomar en ayunas.', '2024-10-17'),
(26, 28, 'Tomar antes de comer', '2024-10-17'),
(27, 28, '', '2024-10-19'),
(28, 28, '', '2024-10-19'),
(29, 28, '', '2024-10-19'),
(30, 28, '', '2024-10-19'),
...
CREATE TABLE `recipes_medicamentos` (
  `id_recipe_medicamento` int(11) DEFAULT NULL,
...
(NULL, NULL, 70, NULL, NULL, NULL, NULL, NULL, '2024-10-19', NULL),
(NULL, 1, 71, 1, 'pastilla', 8, 1, 'semanas', '2024-10-22', NULL);
...
(28, 27333664, 'kleiber2003', 'Kleiber', 'Aranguren', 'Kleiber8113@gmail.com', 'user.jpg', '2024-06-20', '123456', 2, 1),
(35, 27333664, '12345', 'JESUS', 'ARANGUREN', 'JESUSARANGUREN675@GMAIL.COM', '22ENP55LDZHWXKWS42G5CRYTW4.jpeg', '2024-10-12', '12345', 2, 1);
...
--
ALTER TABLE `recipes`
  MODIFY `id_recipe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `tbl_temporal_medicamentos`
  MODIFY `id_temporal_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
