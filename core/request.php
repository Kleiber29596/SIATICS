...
if (!empty($page)) {
	...
	$data = array(
		...
		'listarDatosUsuario'	  => array('model' => 'UsuarioModel', 'view' => 'listarDatosUsuario', 'controller' => 'UsuarioController'),
		...
		'consultarPersonaUsuario'   => array('model'   => 'PersonasModel', 'view'  => 'consultarPersonaUsuario',   	 'controller'     => 'PersonasController'),
