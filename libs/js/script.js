     ...
     columnDefs: [
       {
         ...
         render: function (data, type, row, meta) {
           let botones =
             `
             <button type="button" class="btn btn-primary btn-sm"  onclick="listarDatosConsulta(` +
             row[5] +
             `)"><i class="fas fa-eye"></i></button>&nbsp;
 
             <a href="index.php?page=imprimirRecipe&amp;id=`+ row[5]+`" target="_blank" class="btn btn-danger btn-sm"><i
