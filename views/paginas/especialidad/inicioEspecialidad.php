            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button title="Agregar Especialidad" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregarEspecialidad">
...
<div class="modal fade" id="modalAgregarEspecialidad" tabindex="-1" aria-labelledby="agregarEspecialidad" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalAgregarEspecialidadLabel">Agregar especialidad <i class="fas fa-stethoscope"></i> </h5>
            ...
            <div class="modal-body">
                <form action="" id="formRegistrarEspecialidad">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" onkeyup="mayus(this);" id="especialidad" name="especialidad" placeholder="Ingresa la especialidad">
                            </div>
                        </div>
                        <!--  Campo para el tipo de Modalidad -->
                             <div class="col-sm-4">
                                <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="agregar_especialidad" title="Guardar cambios"><i class="fas fa-save"></i> Guardar</button>
                    </div>
                </form>
