...
INSERT INTO `consultas` (`id_consulta`, `id_tipo_consulta`, `id_persona`, `diagnostico`, `peso`, `altura`, `presion_arterial`, `edad`, `id_recipe`, `id`, `fecha_registro`, `fecha_actualizacion`, `id_especialidad`) VALUES
(1, 8, 1, 'tos seca', 60, 1, '120/80', NULL, 6, 28, '2024-11-21', NULL, 4);
